...
1.  Enter **odl_user_DID_Create_case_for_support_email** for **Rule name**, select the **odl_user_DID_Support** queue you created for Queue to monitor, and select **Email** for Activity type to monitor.
...
1. In the left-hand side of the condition, select **Priority (Email)**

1. Select **Equals** for the operator.

1. In the right-hand side of the condition, select **High**.
...
1. In **Step three: additional actions to take after matching with a condition**, set *Automatically reply to email*  to **Yes**.
